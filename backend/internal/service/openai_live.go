...
func applyLiveUpstreamIdentityHeaders(headers http.Header, account *Account) {
	headers.Set("OpenAI-Alpha", "quicksilver=v2")
	ensureCodexIdentityHeadersForAccount(headers, account)
...
func (s *OpenAIGatewayService) liveSidebandHeaders(
	...
	applyLiveUpstreamIdentityHeaders(headers, account)
	return headers, nil
}
