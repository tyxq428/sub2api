export default {
    accounts: {
      ...
      openai: {
        ...
        codexR2Title: 'Codex R2 effective policy',
        codexR2Desc: 'Read-only local diagnostics for semantic identity and client-profile handling. This panel never enables R2.',
        codexR2EffectiveMode: 'Effective mode',
        codexR2Reason: 'Reason',
        codexR2ClientUA: 'Client UA policy',
        codexR2Profile: 'Protocol profile',
        codexR2Fingerprint: 'Convergence',
        codexR2BindingsActive: 'Active bindings',
        codexR2BindingsDraining: 'Draining bindings',
        codexR2Coverage: 'Observed coverage',
        codexR2Observed: 'Observed events',
        codexR2Conflicts: 'Conflicts',
        codexR2Unknown: 'Unknown',
        codexR2Shadow: 'Shadow telemetry',
        codexR2MappingKeyMissing: 'R2 enforce cannot run without configured mapping key material.',
        codexR2Drain: 'Drain active R2 bindings',
        codexR2DrainConfirm: 'Mark all active R2 bindings for this account as draining? This does not enable or disable the account.',
        codexR2DrainSuccess: 'Marked {count} R2 bindings as draining.',
