export default {
    accounts: {
      ...
      openai: {
        ...
        codexR2Title: 'Codex R2 生效策略',
        codexR2Desc: '语义身份和客户端来源处理的本地只读诊断；此面板不会开启 R2。',
        codexR2EffectiveMode: '生效模式',
        codexR2Reason: '原因',
        codexR2ClientUA: '客户端 UA 策略',
        codexR2Profile: '协议 Profile',
        codexR2Fingerprint: '指纹收敛',
        codexR2BindingsActive: 'Active 绑定',
        codexR2BindingsDraining: 'Draining 绑定',
        codexR2Coverage: '观测覆盖率',
        codexR2Observed: '观测事件',
        codexR2Conflicts: '冲突',
        codexR2Unknown: '未知',
        codexR2Shadow: 'Shadow 遥测',
        codexR2MappingKeyMissing: '未配置映射密钥时，R2 enforce 不能运行。',
        codexR2Drain: 'Drain Active R2 绑定',
        codexR2DrainConfirm: '将此账号所有 Active R2 绑定标记为 Draining？此操作不会启用或禁用账号。',
        codexR2DrainSuccess: '已将 {count} 个 R2 绑定标记为 Draining。',
