...
EVIDENCE = [
    ...
    'fullimage-harness-v3.sha256.json', 'fullimage-harness-v3/run.py',
    'fullimage-harness-v3/load_agent.cjs', 'fullimage-harness-v3/fake_upstream.cjs',
    'fullimage-harness-v3/duplicate_tracker.cjs', 'b8-harness-failure-diagnosis.json',
    'fake-stress-result.txt', 'fullimage-smoke04/result.json',
    'b8-soak03-host-interruption.json', 'b8-soak04-wsl-lifecycle-invalid.json',
    'fullimage-soak05/status.json', 'fullimage-soak05/result.json', 'fullimage-soak05/environment.json',
    'fullimage-soak05/memory.json', 'fullimage-soak05/baseline-latencies.json',
    'fullimage-soak05/candidate-latencies.json', 'fullimage-soak05/agent-result.json',
    'fullimage-soak05/container-states-final.json', 'fullimage-soak05-driver-result.json',
    'fullimage-soak05-driver.sh', 'fullimage-soak05-driver.log', 'fullimage-soak05-launch.json',
...
DOCUMENTS = [
    ...
    'tools/codex-r1-load/fake_upstream.cjs', 'tools/codex-r1-load/duplicate_tracker.cjs', 'tools/codex-r1-load/verify.py',
