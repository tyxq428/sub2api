...
EVIDENCE = [
    ...
    'fullimage-soak03/result.json', 'fullimage-soak03/environment.json',
    'fullimage-soak03/memory.json', 'fullimage-soak03/baseline-latencies.json',
    'fullimage-soak03/candidate-latencies.json', 'fullimage-soak03/container-states-final.json',
    'fullimage-soak03-driver-result.json',
